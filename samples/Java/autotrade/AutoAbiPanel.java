...
public class AutoAbiPanel extends JPanel {
	...
	AutoAbiPanel(String symbol, String qty) {
		this.symbol = symbol;
		this.qty = qty;
...
//	AutoTreadGO autogo ;
	...
	ArrayList<AutoAbi> autoAbi = new ArrayList<AutoAbi>();
	...
	public void autoStart() {
		...
		a= new AutoTradeAbi("EUR/GBP","EUR/USD","GBP/USD");
		a.startTrade();
	
//		HistoricalDataFX data = new HistoricalDataFX();
...
//		long start = API.getCurrenetTime();
//		AutoAbi.buyPostion();
//		long stop  = API.getCurrenetTime();
//		System.out.println("Start = "+ start + ", stop = "+ stop + ", time = "+ (stop - start) );
	}

	public void closeAllPosition() {
//		autoStop();
//		autoAbi1.closeAllPostion();
//		AutoAbi.closePostion();
	}
}
