...
public class ChartATS extends JComponent {
...
//				close_next = getY(m_rows.get(index+1).close());
//			}
...
//			g.drawLine(x, close,x+10, close_next);
//			////
