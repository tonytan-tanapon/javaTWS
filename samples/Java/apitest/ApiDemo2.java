...
public class ApiDemo2 implements IConnectionHandler {
	static {
		NewLookAndFeel.register();
	}
	public static ApiDemo2 INSTANCE;
...
//	private final OptionsPanelTrade m_optionsPanelTrade = new OptionsPanelTrade();
	private final A_AutoTradePanel m_AutotradePanel = new A_AutoTradePanel("test");
	
	private final A_AutoTradePanel m_AutotradePanel2 = new A_AutoTradePanel();
...
//	public final AutoTradePanel m_autoPanel4 = new AutoTradePanel("IBM","stock",1,0.5,0.5,"15", BarSize._15_mins);
	...
	public static void start(ApiDemo2 apiDemo) {
		INSTANCE = apiDemo;
		INSTANCE.run();
	}
	
	public ApiDemo2(IConnectionConfiguration connectionConfig) {
...
//		m_tabbedPanel.addTab( "OptionTrade", m_AutotradePanel);
		m_tabbedPanel.addTab( "OptionTrade", myMediatorControl.m_gui.getPanel());
...
//					m_area.scrollRectToVisible( new Rectangle( 0, d.height, 1, 1) );
	...
	public static void main(String[] args) {
		start(new ApiDemo2(new DefaultConnectionConfiguration()));
