...
//	private final NewsPanel m_newsPanel = new NewsPanel();
	...
	private final AutotradePanel m_autoTrade = new AutotradePanel("AAPL","10");
	private final AoneClickPanel m_oneClick = new AoneClickPanel();
...
//		m_tabbedPanel.addTab( "News", m_newsPanel);
		...
		m_tabbedPanel.addTab( "AutoTrade", m_autoTrade);
		m_tabbedPanel.addTab( "OneClick", m_oneClick);
